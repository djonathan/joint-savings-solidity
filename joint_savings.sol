...
contract JointSavings {
    ...
    */
    function withdraw(uint amount, address payable recipient) public {
        ...
        */
        // Q: Can contractBalance be initialized to address(this).balance?
        // If not, we have to use that construct here?
        ...
        */
        // Q: Is if() less expensive then setting lastToWithdraw?
